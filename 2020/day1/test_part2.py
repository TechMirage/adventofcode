import unittest
from ExpenseReportTwo import ExpenseReport
...
class TestingClass(unittest.TestCase):
    ...
    def test_process(self):
        ...
        self.assertEqual(ans, 241861950)
